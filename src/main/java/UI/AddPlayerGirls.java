 ...
 * @author Gajendran
 */
public class AddPlayerGirls extends javax.swing.JFrame {

    /**
     * Creates new form AddPlayer
     */
    public AddPlayerGirls() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Add Girls Player");
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddPlayerGirls.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddPlayerGirls().setVisible(true);
            }
        });
    }
